...
module GLib
  ...
  # 
  # @method _callback_g_compare_func_(gint, a, b)
  # @param [Integer] gint 
  # @param [FFI::Pointer(Gconstpointer)] a 
  # @param [FFI::Pointer(Gconstpointer)] b 
  # @return [Integer] 
  # @scope class
  callback :g_compare_func, [:int, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_compare_data_func_(gint, a, b, user_data)
  # @param [Integer] gint 
  # @param [FFI::Pointer(Gconstpointer)] a 
  # @param [FFI::Pointer(Gconstpointer)] b 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_compare_data_func, [:int, :pointer, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_equal_func_(gboolean, a, b)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(Gconstpointer)] a 
  # @param [FFI::Pointer(Gconstpointer)] b 
  # @return [Integer] 
  # @scope class
  callback :g_equal_func, [:int, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_func_(data, user_data)
  # @param [FFI::Pointer(Gpointer)] data 
  # @param [FFI::Pointer(Gpointer)] user_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_func, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_hash_func_(guint, key)
  # @param [Integer] guint 
  # @param [FFI::Pointer(Gconstpointer)] key 
  # @return [Integer] 
  # @scope class
  callback :g_hash_func, [:uint, :pointer], :uint
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_gh_func_(key, value, user_data)
  # @param [FFI::Pointer(Gpointer)] key 
  # @param [FFI::Pointer(Gpointer)] value 
  # @param [FFI::Pointer(Gpointer)] user_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :gh_func, [:pointer, :pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_translate_func_(gchar, str, data)
  # @param [Integer] gchar 
  # @param [String] str 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [Integer] 
  # @scope class
  callback :g_translate_func, [:char, :string, :pointer], :char
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_thread_func_(gpointer, data)
  # @param [FFI::Pointer(Gpointer)] gpointer 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_thread_func, [:pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_data_foreach_func_(key_id, data, user_data)
  # @param [Integer] key_id 
  # @param [FFI::Pointer(Gpointer)] data 
  # @param [FFI::Pointer(Gpointer)] user_data 
  # @return [Integer] 
  # @scope class
  callback :g_data_foreach_func, [:uint, :pointer, :pointer], :uint
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_duplicate_func_(gpointer, data, user_data)
  # @param [FFI::Pointer(Gpointer)] gpointer 
  # @param [FFI::Pointer(Gpointer)] data 
  # @param [FFI::Pointer(Gpointer)] user_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_duplicate_func, [:pointer, :pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_node_traverse_func_(gboolean, node, data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(*GNode)] node 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [Integer] 
  # @scope class
  callback :g_node_traverse_func, [:int, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_node_foreach_func_(node, data)
  # @param [FFI::Pointer(*GNode)] node 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [FFI::Pointer(*GNode)] 
  # @scope class
  callback :g_node_foreach_func, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_copy_func_(gpointer, src, data)
  # @param [FFI::Pointer(Gpointer)] gpointer 
  # @param [FFI::Pointer(Gconstpointer)] src 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_copy_func, [:pointer, :pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_ghr_func_(gboolean, key, value, user_data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(Gpointer)] key 
  # @param [FFI::Pointer(Gpointer)] value 
  # @param [FFI::Pointer(Gpointer)] user_data 
  # @return [Integer] 
  # @scope class
  callback :ghr_func, [:int, :pointer, :pointer, :pointer], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_hook_compare_func_(gint, new_hook, sibling)
  # @param [Integer] gint 
  # @param [FFI::Pointer(*GHook)] new_hook 
  # @param [FFI::Pointer(*GHook)] sibling 
  # @return [Integer] 
  # @scope class
  callback :g_hook_compare_func, [:int, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_hook_find_func_(gboolean, hook, data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(*GHook)] hook 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [Integer] 
  # @scope class
  callback :g_hook_find_func, [:int, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_hook_marshaller_(hook, marshal_data)
  # @param [FFI::Pointer(*GHook)] hook 
  # @param [FFI::Pointer(Gpointer)] marshal_data 
  # @return [FFI::Pointer(*GHook)] 
  # @scope class
  callback :g_hook_marshaller, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_hook_check_marshaller_(gboolean, hook, marshal_data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(*GHook)] hook 
  # @param [FFI::Pointer(Gpointer)] marshal_data 
  # @return [Integer] 
  # @scope class
  callback :g_hook_check_marshaller, [:int, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_hook_check_func_(gboolean, data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [Integer] 
  # @scope class
  callback :g_hook_check_func, [:int, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_hook_finalize_func_(hook_list, hook)
  # @param [FFI::Pointer(*GHookList)] hook_list 
  # @param [FFI::Pointer(*GHook)] hook 
  # @return [FFI::Pointer(*GHookList)] 
  # @scope class
  callback :g_hook_finalize_func, [:pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_poll_func_(gint, ufds, nfsd, timeout)
  # @param [Integer] gint 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_poll_func, [:int, :pointer, :uint, :int], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_source_func_(gboolean, user_data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(Gpointer)] user_data 
  # @return [Integer] 
  # @scope class
  callback :g_source_func, [:int, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_child_watch_func_(pid, status, user_data)
  # @param [FFI::Pointer(GPid)] pid 
  # @param [Integer] status 
  # @param [FFI::Pointer(Gpointer)] user_data 
  # @return [FFI::Pointer(GPid)] 
  # @scope class
  callback :g_child_watch_func, [:pointer, :int, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_gio_func_(gboolean, source, condition, data)
  # @param [Integer] gboolean 
  ...
  # @return [Integer] 
  # @scope class
  callback :gio_func, [:int, GIOChannel, :char, :pointer], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_log_func_(log_domain, log_level, message, user_data)
  ...
  # @return [String] 
  # @scope class
  callback :g_log_func, [:string, :g_log_level_flags, :string, :pointer], :string
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_option_arg_func_(gboolean, option_name, value, data, error)
  # @param [Integer] gboolean 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_option_arg_func, [:int, :string, :string, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_option_parse_func_(gboolean, context, group, data, error)
  # @param [Integer] gboolean 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_option_parse_func, [:int, GOptionContext, GOptionGroup, :pointer, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_option_error_func_(context, group, data, error)
  # @param [GOptionContext] context 
  # @param [GOptionGroup] group 
  # @param [FFI::Pointer(Gpointer)] data 
  # @param [FFI::Pointer(**GError)] error 
  ...
  # @scope class
  callback :g_option_error_func, [GOptionContext, GOptionGroup, :pointer, :pointer], GOptionContext
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_regex_eval_callback_(gboolean, match_info, result, user_data)
  # @param [Integer] gboolean 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_regex_eval_callback, [:int, GMatchInfo, GString, :pointer], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_scanner_msg_func_(scanner, message, error)
  # @param [FFI::Pointer(*GScanner)] scanner 
  # @param [String] message 
  # @param [Integer] error 
  # @return [FFI::Pointer(*GScanner)] 
  # @scope class
  callback :g_scanner_msg_func, [:pointer, :string, :int], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_sequence_iter_compare_func_(gint, a, b, data)
  # @param [Integer] gint 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_sequence_iter_compare_func, [:int, GSequenceNode, GSequenceNode, :pointer], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_test_fixture_func_(fixture, user_data)
  # @param [FFI::Pointer(Gpointer)] fixture 
  # @param [FFI::Pointer(Gconstpointer)] user_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_test_fixture_func, [:pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_test_log_fatal_func_(gboolean, log_domain, log_level, message, user_data)
  # @param [Integer] gboolean 
  # @param [String] log_domain 
  # @param [Symbol from _enum_g_log_level_flags_] log_level 
  # @param [String] message 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_test_log_fatal_func, [:int, :string, :g_log_level_flags, :string, :pointer], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_traverse_func_(gboolean, key, value, data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(Gpointer)] key 
  # @param [FFI::Pointer(Gpointer)] value 
  # @param [FFI::Pointer(Gpointer)] data 
  # @return [Integer] 
  # @scope class
  callback :g_traverse_func, [:int, :pointer, :pointer, :pointer], :int
