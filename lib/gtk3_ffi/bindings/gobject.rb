...
module GObject
  ...
  # 
  # @method _callback_g_class_init_func_(g_class, class_data)
  # @param [FFI::Pointer(Gpointer)] g_class 
  # @param [FFI::Pointer(Gpointer)] class_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_class_init_func, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_class_finalize_func_(g_class, class_data)
  # @param [FFI::Pointer(Gpointer)] g_class 
  # @param [FFI::Pointer(Gpointer)] class_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_class_finalize_func, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_instance_init_func_(instance, g_class)
  # @param [GTypeInstance] instance 
  # @param [FFI::Pointer(Gpointer)] g_class 
  # @return [GTypeInstance] 
  # @scope class
  callback :g_instance_init_func, [GTypeInstance, :pointer], GTypeInstance
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_interface_init_func_(g_iface, iface_data)
  # @param [FFI::Pointer(Gpointer)] g_iface 
  # @param [FFI::Pointer(Gpointer)] iface_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_interface_init_func, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_interface_finalize_func_(g_iface, iface_data)
  # @param [FFI::Pointer(Gpointer)] g_iface 
  # @param [FFI::Pointer(Gpointer)] iface_data 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_interface_finalize_func, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_type_class_cache_func_(gboolean, cache_data, g_class)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(Gpointer)] cache_data 
  # @param [GTypeClass] g_class 
  # @return [Integer] 
  # @scope class
  callback :g_type_class_cache_func, [:int, :pointer, GTypeClass], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_type_interface_check_func_(check_data, g_iface)
  # @param [FFI::Pointer(Gpointer)] check_data 
  # @param [FFI::Pointer(Gpointer)] g_iface 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_type_interface_check_func, [:pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_value_transform_(src_value, dest_value)
  # @param [FFI::Pointer(*GValue)] src_value 
  # @param [FFI::Pointer(*GValue)] dest_value 
  # @return [FFI::Pointer(*GValue)] 
  # @scope class
  callback :g_value_transform, [:pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_closure_notify_(data, closure)
  # @param [FFI::Pointer(Gpointer)] data 
  # @param [FFI::Pointer(*GClosure)] closure 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_closure_notify, [:pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_closure_marshal_(closure, return_value, n_param_values, param_values, invocation_hint, marshal_data)
  # @param [FFI::Pointer(*GClosure)] closure 
  ...
  # @scope class
  callback :g_closure_marshal, [:pointer, GValue, :uint, GValue, :pointer, :pointer], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_va_closure_marshal_(closure, return_value, instance, args, marshal_data, n_params, param_types)
  # @param [FFI::Pointer(*GClosure)] closure 
  # @param [GValue] return_value 
  # @param [FFI::Pointer(Gpointer)] instance 
  # @param [String] args 
  ...
  # @return [FFI::Pointer(*GClosure)] 
  # @scope class
  callback :g_va_closure_marshal, [:pointer, GValue, :pointer, :string, :pointer, :int, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_signal_emission_hook_(gboolean, ihint, n_param_values, param_values, data)
  # @param [Integer] gboolean 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_signal_emission_hook, [:int, :pointer, :uint, GValue, :pointer], :int
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_signal_accumulator_(gboolean, ihint, return_accu, handler_return, data)
  # @param [Integer] gboolean 
  # @param [FFI::Pointer(*GSignalInvocationHint)] ihint 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_signal_accumulator, [:int, :pointer, GValue, GValue, :pointer], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_boxed_copy_func_(gpointer, boxed)
  # @param [FFI::Pointer(Gpointer)] gpointer 
  # @param [FFI::Pointer(Gpointer)] boxed 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_boxed_copy_func, [:pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_object_get_property_func_(object, property_id, value, pspec)
  ...
  # @scope class
  callback :g_object_get_property_func, [:pointer, :uint, GValue, GParamSpec], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_object_set_property_func_(object, property_id, value, pspec)
  # @param [FFI::Pointer(*GObject)] object 
  # @param [Integer] property_id 
  # @param [GValue] value 
  # @param [GParamSpec] pspec 
  # @return [FFI::Pointer(*GObject)] 
  # @scope class
  callback :g_object_set_property_func, [:pointer, :uint, GValue, GParamSpec], :pointer
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_weak_notify_(data, where_the_object_was)
  # @param [FFI::Pointer(Gpointer)] data 
  # @param [FFI::Pointer(*GObject)] where_the_object_was 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_weak_notify, [:pointer, :pointer], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_toggle_notify_(data, object, is_last_ref)
  # @param [FFI::Pointer(Gpointer)] data 
  # @param [GObject] object 
  # @param [Integer] is_last_ref 
  # @return [FFI::Pointer(Gpointer)] 
  # @scope class
  callback :g_toggle_notify, [:pointer, GObject, :int], :pointer
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_binding_transform_func_(gboolean, binding, source_value, target_value, user_data)
  # @param [Integer] gboolean 
  ...
  # @return [Integer] 
  # @scope class
  callback :g_binding_transform_func, [:int, GBinding, GValue, GValue, :pointer], :int
  ...
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_type_plugin_complete_type_info_(plugin, g_type, info, value_table)
  # @param [GTypePlugin] plugin 
  # @param [Integer] g_type 
  # @param [GTypeInfo] info 
  ...
  # @return [GTypePlugin] 
  # @scope class
  callback :g_type_plugin_complete_type_info, [GTypePlugin, :uint, GTypeInfo, GTypeValueTable], GTypePlugin
  
  # (Not documented)
  # 
  # <em>This entry is only for documentation and no real method.</em>
  # 
  # @method _callback_g_type_plugin_complete_interface_info_(plugin, instance_type, interface_type, info)
  # @param [GTypePlugin] plugin 
  # @param [Integer] instance_type 
  # @param [Integer] interface_type 
  # @param [GInterfaceInfo] info 
  # @return [GTypePlugin] 
  # @scope class
  callback :g_type_plugin_complete_interface_info, [GTypePlugin, :uint, :uint, GInterfaceInfo], GTypePlugin
